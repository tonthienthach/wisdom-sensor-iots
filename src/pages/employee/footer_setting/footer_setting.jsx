import '../footer_setting/footer_setting.css';
      ...
      <div className="footer-container">
        ...
        <div className="footer-bottom">
          <div className="footer-column">
            <h3>Contact Us</h3>
            <p>We are an award-winning multinational company. We believe in quality and standards worldwide.</p>
            <div className="contact-info">
              <img src="../../../images/Location.png" alt="Button" />
              <span>760 Nguyen Duy Trinh Street, Binh Trung Dong Ward, District 2, Ho Chi Minh City.</span>
            </div>
            <div className="contact-info">
            ...
            <div className="contact-info">
              <img src="../../../images/web.png" alt="Button" />
